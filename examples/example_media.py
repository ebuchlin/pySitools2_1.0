...
sdo_data_list = media_search( DATES=[d1,d2], WAVES=['335','304'], CADENCE=['1 min'] , NB_RES_MAX= 5) 
...
#media_get (MEDIA_DATA_LIST=sdo_data_list,TARGET_DIR='/tmp', DECOMPRESS=True)

#Need to get a tar ball or zip file do sthg like :
media_get(MEDIA_DATA_LIST=sdo_data_list, TARGET_DIR="/tmp" , DOWNLOAD_TYPE="tar", FILENAME="my_download_file")
