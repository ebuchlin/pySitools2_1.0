...
def main():
    ...
    #date__ob
    #Format must be somthing like 2015-11-01T00:00:00.000 in version Sitools2
    # 3.0 that will change 
    param_query1 = [
                     [ds1.fields_dict['date_obs']], 
                     ['2014-01-01T00:00:00.000', '2014-01-01T01:00:00.000'],
                     'DATE_BETWEEN'
    ]
    ...
    # try :
    ds1.execute_plugin(plugin_name='pluginSOHOtar', 
        pkey_list=[result[1]['id_sitools_view']], 
        FILENAME='first_download_SOHO.tar')
    # except :
    #     print (
    # "Issue downloading id_sitools_view : %s " % result[1]['id_sitools_view'])
    # else :
    #     print (
    #"Download id_sitools_view : %s completed" % result[1]['id_sitools_view'] )
