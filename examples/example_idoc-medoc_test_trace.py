...
def main():
    ...
    print ("sitools2 : %s " % sitools2.list_project())

    ds1 = Dataset(sitools_url + "/webs_TRACE_dataset")
    ds1.display()

    # date__ob
    # Format must be something like 2015-11-01T00:00:00.000 in version Sitools2 3.0 that will change
    param_query1 = [[ds1.fields_dict['date_obs']], ['2004-01-01T00:00:00.000', '2004-01-02T00:00:00.000'],
                    'DATE_BETWEEN']
    ...
    print ("Download just one TRACE data\nIn progress please wait ...")
    print("item : \n%s" % result[1])
