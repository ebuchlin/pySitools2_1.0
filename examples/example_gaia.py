...
#get(GAIA_LIST=gaia_data_list, TARGET_DIR="/tmp", TYPE=['temp','em'])

#Need to do it verbosly
#get(GAIA_LIST=gaia_data_list, TARGET_DIR="/tmp",QUIET=False)

#Need to get a tar ball do sthg like :
#get_selection(GAIA_LIST=gaia_data_list, TARGET_DIR="/tmp" ,FILENAME="my_dowload_file")
